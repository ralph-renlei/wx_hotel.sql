...
-- Records of goods
-- ----------------------------
INSERT INTO `goods` VALUES ('4', '18973', '地字 002号', '2017-08-17 11:34:17', '2017-08-21 17:39:28', '1', '1');
INSERT INTO `goods` VALUES ('5', '18973', '地字 001号', '2017-08-17 11:55:34', '2017-08-21 17:39:31', '1', '1');
...
INSERT INTO `goods` VALUES ('9', '18973', '地字 003号', '2017-08-18 15:18:28', '2017-08-21 17:39:34', '1', '1');
INSERT INTO `goods` VALUES ('10', '18972', '玄子 001号', '2017-08-18 15:23:45', '2017-08-18 15:23:45', '1', '0');
INSERT INTO `goods` VALUES ('11', '18972', '玄子 002号', '2017-08-18 15:23:57', '2017-08-21 17:39:21', '1', '1');
INSERT INTO `goods` VALUES ('12', '18972', '玄子 003号', '2017-08-18 15:24:20', '2017-08-21 17:39:25', '1', '1');
...
CREATE TABLE `orders` (
  ...
  `order_status` tinyint(1) unsigned DEFAULT '0' COMMENT '0待审核 1预定成功 2已完成',
  `pay_status` tinyint(1) unsigned DEFAULT '0' COMMENT '0 未付款 1 已付款',
  `openid` varchar(64) DEFAULT NULL,
  `uid` int(11) DEFAULT '0',
  `goods_id` int(11) DEFAULT '0',
  `goods_name` varchar(120) DEFAULT '',
  `goods_price` decimal(10,2) DEFAULT '0.00' COMMENT '实际单价',
  `bonus` decimal(10,2) DEFAULT '0.00' COMMENT '积分',
  `order_amount` decimal(10,2) DEFAULT '0.00',
  `add_time` datetime DEFAULT NULL,
  `forms` tinyint(1) DEFAULT '1' COMMENT '1 线上预定 0 线下预定',
...
INSERT INTO `orders` VALUES ('10', '201708191528544888', '2', '1', 'oG3Ulv_z-uJsb-uUmy6m62J5qxc0', '1', '5', '地字 001号', '258.00', '0.00', '258.00', '2017-08-19 15:28:54', '1', null, '2017-8-19', '2017-8-20', '1', '18973', '标间', '15639288529', '任磊');
INSERT INTO `orders` VALUES ('15', '201708210900259813', '1', '0', 'oG3Ulv_z-uJsb-uUmy6m62J5qxc0', '1', '10', '玄子 001号', '498.00', '0.00', '498.00', '2017-08-21 09:00:25', '0', null, '2017-8-21', '2017-8-22', '1', '18972', '双床房', '15639288529', '任磊');
...
-- ----------------------------
INSERT INTO `room_status` VALUES ('4', '10', '任磊', '15639288529', null, null, '地字 001号', '??', '1');
INSERT INTO `room_status` VALUES ('5', '15', '任磊', '15639288529', '2017-8-21', '2017-8-22', '玄子 001号', '双床房', '1');
...
CREATE TABLE `users` (
  ...
  `verify` tinyint(1) NOT NULL DEFAULT '0' COMMENT '-1 审核中 0未认证 1已认证',
...
INSERT INTO `users` VALUES ('20', 'member', null, null, null, '', '小王八', null, null, '15639288529', null, null, null, null, null, null, null, null, null, null, null, null, null, null, '0.00', null, '10000', '1', '0', '0', '-1', null, '2017-08-21 15:14:53', '2017-08-21 15:14:53', null);
